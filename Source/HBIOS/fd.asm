...
;FDC_DOR		.EQU	$82		; DIGITAL OUTPUT REGISTER (LATCH)
;FDC_DMA		.EQU	$83		; PSEUDO DMA DATA PORT
...
;	
	PRTS(" IO=0x$")
	CALL	FC_MOTOROFF		; SHUTDOWN MOTOR AT BOOT!
...
;	LD	(FCD_IDLECNT),BC
	...
	LD	A,0FFH
	OUT0	(Z180_TRDR),A		; And turn it on
	LD	A,10H
	OUT0	(Z180_CNTR),A
...
FC_MOTOROFF:
	LD	A,00H
	OUT0	(Z180_TRDR),A		; And turn it off
	LD	A,10H
	OUT0	(Z180_CNTR),A
