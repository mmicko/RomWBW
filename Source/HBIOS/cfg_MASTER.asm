...
#INCLUDE "hbios.inc"
;
PLATFORM	.EQU	PLT_NONE	; PLT_[SBC|ZETA|ZETA2|N8|MK4|UNA|RC2014|RCZ80|RCEZ80|RCZ180|EZZ80|SCZ180|GMZ180|DYNO|RCZ280|MBC|RPH|Z80RETRO|SZ180|DUO|HEATH|EPITX|MON|STDZ180|NABU|SZ80|N8PC|MECB]
...
CPUOSC		.EQU	1000000		; CPU OSC FREQ IN HZ
...
Z180_CLKDIV	.EQU	1		; Z180: CLK DIV: 0=OSC/2, 1=OSC, 2=OSC*2
Z180_MEMWAIT	.EQU	0		; Z180: MEMORY WAIT STATES (0-3)
Z180_IOWAIT	.EQU	1		; Z180: I/O WAIT STATES TO ADD ABOVE 1 W/S BUILT-IN (0-3)
Z180_TIMER	.EQU	FALSE		; Z180: ENABLE Z180 SYSTEM PERIODIC TIMER
Z180_RAMLOC .EQU    $40     ; Z180: START RAM LOCATION $80 FOR Z180, $40 FOR HD64180
;
...
ANSI_CLSONFF	.EQU	FALSE		; ANSI DRIVER TREAT FORMFEED AS CLEAR SCREEN
...
TMSMODE		.EQU	TMSMODE_NONE	; TMS: DRIVER MODE: TMSMODE_[SCG|N8|MSX|MSXKBD|MSXMKY|MBC|COLECO|DUO|NABU|MSXUKY|N8PC|MECB]
...
T011ENABLE	.EQU	FALSE		; TIMVDU: ENABLE TIM VIDEO DRIVERS (TIMVDU.ASM)
;
...
SDMODE		.EQU	SDMODE_NONE	; SD: DRIVER MODE: SDMODE_[JUHA|N8|CSIO|PPI|UART|DSD|MK4|SC|MT|USR|ZPIO|GPIO|Z80R|EPITX|T35|GM|EZ512|K80W]
...
SCSIBASE	.EQU	$48		; SCSI: BASE I/O ADDRESS OF 5380
SCSIMODE	.EQU	SCSIMODE_LATCH	; SCSI: DRIVER MODE: SCSIMODE_[DIRECT|LATCH]
SCSIPDMA	.EQU	FALSE		; SCSI: ENABLE PSEUDO-DMA
...
EZ80_MEM_MIN_BC	.EQU	1		; MINIMUM BUS CYCLES TO APPLY, IF EZ80_WSMD_TYP = EZ80WSMD_CALC
;
; BUS TIMING FOR EXTERNAL I/O ACCESS (CS2)
EZ80_IO_CYCLES	.EQU	4		; IO BUS CYCLES (1-15) TO APPLY, IF EZ80_WSMD_TYP = EZ80WSMD_CYCLES
EZ80_IO_MIN_NS	.EQU	250		; CALCULATE AT BOOT TIME THE REQUIRED B/C, IF EZ80_WSMD_TYP = EZ80WSMD_CALC
EZ80_IO_MIN_BC	.EQU	4		; MINIMUM BUS CYCLES TO APPLY, IF EZ80_WSMD_TYP = EZ80WSMD_CALC
;
; APPLY BUS CYCLES OR CALCULATE CYCLES BASED ON DESIRED PERIOD
EZ80_WSMD_TYP	.EQU	EZ80WSMD_CALC	; BUS WAIT STATE CONFIG: EZ80WSMD_[CALC|CYCLES]
;
