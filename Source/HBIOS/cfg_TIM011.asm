;
;==================================================================================================
;   ROMWBW PLATFORM CONFIGURATION DEFAULTS FOR PLATFORM: TIM011
;==================================================================================================
;
...
;
#DEFINE PLATFORM_NAME	"TIM011", " [", CONFIG, "]"	; TEXT LABEL OF THIS CONFIG IN STARTUP MESSAGES
...
;
PLATFORM	.SET	PLT_TIM011	; PLT_[SBC|ZETA|ZETA2|N8|MK4|UNA|RC2014|RCZ80|RCEZ80|RCZ180|EZZ80|SCZ180|GMZ180|DYNO|RCZ280|MBC|RPH|Z80RETRO|SZ180|DUO|HEATH|EPITX|MON|STDZ180|NABU|SZ80|N8PC|MECB]
...
CPUOSC		.SET	12288000	; CPU OSC FREQ IN HZ
...
Z180_CLKDIV	.SET	0		; Z180: CLK DIV: 0=OSC/2, 1=OSC, 2=OSC*2
Z180_MEMWAIT	.SET	0		; Z180: MEMORY WAIT STATES (0-3)
Z180_IOWAIT	.SET	1		; Z180: I/O WAIT STATES TO ADD ABOVE 1 W/S BUILT-IN (0-3)
Z180_TIMER	.SET	TRUE		; Z180: ENABLE Z180 SYSTEM PERIODIC TIMER
;Z180_RAMLOC .SET    $40     ; Z180: START RAM LOCATION $80 FOR Z180, $40 FOR HD64180
;
...
ANSI_CLSONFF	.SET	FALSE		; ANSI DRIVER TREAT FORMFEED AS CLEAR SCREEN
...
TMSMODE		.SET	TMSMODE_MSX	; TMS: DRIVER MODE: TMSMODE_[SCG|N8|MSX|MSXKBD|MSXMKY|MBC|COLECO|DUO|NABU|MSXUKY|N8PC|MECB]
...
T011ENABLE	.SET	TRUE		; TIMVDU: ENABLE TIM VIDEO DRIVERS (TIMVDU.ASM)
;
...
SDMODE		.SET	SDMODE_ZPIO	; SD: DRIVER MODE: SDMODE_[JUHA|N8|CSIO|PPI|UART|DSD|MK4|SC|MT|USR|ZPIO|GPIO|Z80R|EPITX|T35|GM|EZ512|K80W]
