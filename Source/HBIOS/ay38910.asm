...
#ENDIF
	...
	EZ80_IO
	OUT0 (AY_RSEL),A		; WANT TO WRITE TO
	LD	A,E			; WRITE THE VALUE TO
	EZ80_IO
	OUT0 (AY_RDAT),A		; THE SELECTED REGISTER
#IF (CPUFAM == CPU_Z180)
...
#ENDIF
	LD	A,D			; SELECT THE REGISTER WE
	EZ80_IO
	OUT0 (AY_RSEL),A		; WANT TO READ
	EZ80_IO
	IN0	A,(AY_RIN)		; READ SELECTED REGISTER
	LD	E,A
#IF (CPUFAM == CPU_Z180)
	POP	AF			; GET SAVED DCNTL VALUE
	OUT0	(Z180_DCNTL),A		; AND RESTORE IT
