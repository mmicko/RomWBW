...
#ENDIF
;
#IF (SDMODE == SDMODE_TIM011)		; NO CS SIGNAL - RET ON SELECT
SD_DEVMAX	.EQU	1		; NUMBER OF PHYSICAL UNITS (SOCKETS)
SD_OPRREG	.EQU	RTCIO		; NOT USED
SD_OPRDEF	.EQU	%00000000	; NOT USED
SD_OPRMSK	.EQU	%00000100	; NOT USED
SD_CS0		.EQU	%00000100	; NOT USED
SD_CNTR		.EQU	Z180_CNTR
SD_TRDR		.EQU	Z180_TRDR
SD_IOBASE	.EQU	Z180_CNTR	; IOBASE
SD_INVCS	.EQU	FALSE		; INVERT CS
		DEVECHO	"TIM"
;
;RTCDEF		.SET	RTCDEF | SD_OPRDEF	; SET DEFAULT IN HBIOS MAINLINE
...
;
#IF ((SDMODE == SDMODE_CSIO) | (SDMODE == SDMODE_TIM011) | (SDMODE == SDMODE_MK4) | (SDMODE == SDMODE_SC) | (SDMODE == SDMODE_GM) | (SDMODE == SDMODE_EPITX))
...
SD_DONE:
	...
	LD	A,$FF
	CALL	SD_PUT
#IF ((SDMODE == SDMODE_CSIO) | (SDMODE == SDMODE_TIM011) | (SDMODE == SDMODE_MK4) | (SDMODE == SDMODE_SC) | (SDMODE == SDMODE_EPITX) | (SDMODE == SDMODE_GM))
	; MAKE SURE CSIO IS DONE SENDING DATA
	CALL	SD_WAITTX		; WAIT FOR TE TO CLEAR
	CALL	DLY32			; WAIT A BIT MORE FOR FINAL BIT
#ENDIF
...
;
MIRROR:
#IF (((SDMODE == SDMODE_CSIO) | (SDMODE == SDMODE_TIM011) | (SDMODE == SDMODE_MK4) | (SDMODE == SDMODE_SC) | (SDMODE == SDMODE_EPITX) | (SDMODE == SDMODE_GM)) & SDCSIOFAST)
