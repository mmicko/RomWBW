...
; 28. MECB	Digicool Things MECB Kits
;
...
SDMODE_ZPIO	.EQU	11		; Z80 ZILOG PIO
...
SDMODE_GPIO	.EQU	18		; Z80 BIT-BANG
SDMODE_TIM011 .EQU 19   ; CSIO without CS
;
...
AYMODE_RC2014	.EQU	3		; RC2014 WHY-EMULATOR / ED BRINDLEY SOUND MODULE
AYMODE_RCZ180	.EQU	4		; ED BRINDLEY SOUND MODULE ON Z180
AYMODE_MSX	.EQU	5		; RCBUS SOUND MODULE AT MSX PORTS
...
AYMODE_COLECO	.EQU	11		; AY ON COLECOVISION-LIKE PORTS ($50/$51)
AYMODE_TIM011	.EQU	12		; AY ON TIM-011
;
...
TMSMODE_MECB	.EQU	12		; MECB V9958 
;
...
;
; SCSI DRIVER MODE SELECTIONS
;
SCSIMODE_NONE	.EQU	0		; NONE
SCSIMODE_DIRECT	.EQU	1		; 5380 REGISTERS MAPPED TO SEQUENTIAL PORTS
SCSIMODE_LATCH	.EQU	2		; 5380 REGISTERS SELECTED VIA LATCH
;
...
DSCVAL	.EQU	DEFSERCFG
  ...
  #IF ((DSCVAL & %1111100000000) == SER_BAUD9600
	SYSECHO	"9600"
  #ENDIF
  #IF ((DSCVAL & %1111100000000) == SER_BAUD19200
	SYSECHO	"19200"
  #ENDIF
